...
//
//  Created by Daniel Tischenko on 18.01.2022.
//
...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_feedImageViewLoadingIndicator_isVisibleWhileLoadingImages() {
        let (sut, loader) = makeSUT()
    ...
    private func assertThat(_ sut: FeedViewController, hasViewConfiguredFor image: FeedImage, at index: Int, file: StaticString = #filePath, line: UInt = #line) {
        ...
        guard let cell = view as? FeedImageCell else {
            return XCTFail("Expected \(FeedImageCell.self) instane, got \(String(describing: view)) instead", file: file, line: line)
        }
