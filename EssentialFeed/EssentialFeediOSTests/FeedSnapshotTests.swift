...
class FeedSnapshotTests: XCTestCase {
    ...
    func test_feedWithErrorMessage() {
        ...
        assert(snapshot: sut.snapshot(for: .iPhone13Pro(style: .light)), named: "FEED_WITH_ERROR_MESSAGE_light")
        assert(snapshot: sut.snapshot(for: .iPhone13Pro(style: .dark)), named: "FEED_WITH_ERROR_MESSAGE_dark")
    }
...
struct SnapshotConfiguration {
    ...
    static func iPhone13Pro(style: UIUserInterfaceStyle) -> SnapshotConfiguration {
        SnapshotConfiguration(
            size: CGSize(width: 390, height: 844),
            safeAreaInsets: UIEdgeInsets(top: 47, left: 0, bottom: 34, right: 0),
            layoutMargins: UIEdgeInsets(top: 55, left: 16, bottom: 0, right: 16),
...
private final class SnapshotWindow: UIWindow {
    private var configuration: SnapshotConfiguration = .iPhone13Pro(style: .light)
